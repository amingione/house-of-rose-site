...
Use the Leads objective with website conversion, Advantage+ placements, and one broad 35+ ad set within 20 miles of the studio. Launch variants 01A, 02A, and 04A first. Rotate the remaining concepts after seven days rather than running all twelve at once.

Every destination below includes the required trailing slash before its query string.

## 01 — Local proof

### 01A — Passed it

- **Primary text:** You may have passed our blue-and-gold entrance on E Olympia Avenue. Inside is House of Rose Aesthetics—a private, appointment-only studio for advanced aesthetics and wellness in Punta Gorda. Begin with a complimentary skin consultation and a clear conversation about what fits.
- **Headline:** A More Considered First Visit
- **Description:** Private appointments in Punta Gorda.
- **CTA:** Learn More
- **Destination:** `https://houseofrosefl.com/skin-analysis/?utm_source=facebook&utm_medium=paid_social&utm_campaign=hor_skin_consult_q3&utm_content=01a_local_proof_feed`
...
- **Primary text:** See your skin before choosing a treatment. An AI-assisted skin consultation gives your provider a clearer baseline for discussing texture, pigmentation, pores, hydration cues, and signs of sun exposure. The consultation is complimentary, private, and pressure-free.
- **Headline:** See Your Skin First
- **Description:** Begin with context, not guesswork.
- **CTA:** Learn More
- **Destination:** `https://houseofrosefl.com/skin-analysis/?utm_source=facebook&utm_medium=paid_social&utm_campaign=hor_skin_consult_q3&utm_content=02a_see_first_feed`

### 02B — Clear starting point

- **Primary text:** The right first step may be a treatment—or it may be a better conversation. House of Rose uses AI-assisted imaging where it helps, then considers your goals, candidacy, and preferences before recommending a direction.
- **Headline:** A Clearer Starting Point
- **Description:** Complimentary skin consultation in Punta Gorda.
- **CTA:** Sign Up
- **Destination:** `https://houseofrosefl.com/skin-analysis/?utm_source=instagram&utm_medium=paid_social&utm_campaign=hor_skin_consult_q3&utm_content=02b_clear_start_story`

## 03 — Studio experience

### 03A — Private appointment

- **Primary text:** A private appointment should feel different: calm, considered, and never rushed. House of Rose brings advanced aesthetics and warm hospitality together in a Punta Gorda studio designed for thoughtful care.
- **Headline:** A Private Appointment
- **Description:** A clear plan in an unhurried setting.
- **CTA:** Learn More
- **Destination:** `https://houseofrosefl.com/skin-analysis/?utm_source=facebook&utm_medium=paid_social&utm_campaign=hor_skin_consult_q3&utm_content=03a_private_appointment_feed`

### 03B — No treatment-menu pressure
...
- **CTA:** Learn More
- **Destination:** `https://houseofrosefl.com/services/injectables/?utm_source=facebook&utm_medium=paid_social&utm_campaign=hor_injectables_q3&utm_content=05a_restraint_feed`

### 05B — Natural-looking approach
...
- **Primary text:** Meet Diana, RN, the House of Rose provider for injectable consultations. Her consultation-first approach keeps the conversation focused on anatomy, candidacy, preferences, and an appropriate plan.
- **Headline:** Meet Diana, RN
- **Description:** Licensed-provider care in Punta Gorda.
- **CTA:** Learn More
- **Destination:** `https://houseofrosefl.com/services/injectables/?utm_source=facebook&utm_medium=paid_social&utm_campaign=hor_injectables_q3&utm_content=06a_meet_diana_feed`

### 06B — Person behind the plan

- **Primary text:** A treatment plan is only as thoughtful as the person guiding it. Diana, RN, leads injectable consultations at House of Rose with a measured approach and clear discussion of candidacy, options, and expectations.
- **Headline:** Meet the Person Behind the Plan
- **Description:** Private injectable consultations.
- **CTA:** Learn More
- **Destination:** `https://houseofrosefl.com/services/injectables/?utm_source=instagram&utm_medium=paid_social&utm_campaign=hor_injectables_q3&utm_content=06b_provider_voice_story`

## Higher-intent Instant Form fallback

Use only if the website lead campaign produces fewer than three verified leads by day 14 and the landing page and tracking have been reconfirmed.
