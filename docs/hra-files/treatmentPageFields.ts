 ...
 *
 *   import { treatmentPageFields } from './fields/treatmentPageFields';
 *   // ...
 *   fields: [
 ...
 * see `scripts/verify-treatment-pages.mjs`, which fails the build when a service
 * with `status: "live"` is missing a required block.
 */
