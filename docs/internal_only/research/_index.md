...
|---|---|---|---|---|
| Topical PRF (advanced-facial adjunct) | Amber — advanced facials (PRF **topical only**) | `prf-topical.md` | `/services/prf/`, `/services/prf-microneedling/`, `/services/prf-body-treatments/`; cost `prf-microneedling-cost-punta-gorda` | comparison `/compare/topical-prf-vs-injectable-prf/`; caseStudy `/results/topical-prf-texture-tightening/`; blog PRF-vs-PRP-vs-fillers explainer under `/blog/` |
| Microneedling | Amber — advanced esthetics | `MICRONEEDLING/microneedling.md` | `/services/microneedling/`, `/services/microneedling-body/`; cost `/cost/microneedling-cost-punta-gorda/` | comparison `/compare/microneedling-vs-biorepeel/`; concern `/concerns/scars-textural/`; caseStudy `/results/[slug]/` |
| Procell Microchanneling (branded context, not a separate modality) | Amber — advanced esthetics | `PROCELL/procell.md` | `/services/microneedling/`, `/services/microneedling-body/` | manufacturer/material research only; no separate service, cost, or comparison page |
| Procell growth-factor serums (MD vs Pro) | Amber — advanced facials | `PROCELL/procell.md` | `/services/microneedling/` | comparison `/compare/Procell-pro-vs-md/`; concern `/concerns/dull-uneven-texture/`; caseStudy `/results/Procell-microchanneling-texture/` |
...
| Facial waxing | Brandy | `waxing.md` | `/services/facial-waxing/` | comparison `/compare/waxing-vs-dermaplaning/`; feed `/areas/punta-gorda/` with facial waxing |
| Jane Iredale products | Retail (`/shop/`) | `product-lines.md` | `/shop/jane-iredale/` product-education page; no individual `product` docs yet | Backfill verified product inventory and pricing in Sanity before enabling product checkout |
| Advanced skin imaging | Cross-cutting front door (routes to Amber/Diana/Brandy) | `advanced-skin-imaging.md` | Singleton `/skin-analysis/` (no price; not a `service` doc) | concern `/concerns/pigmentation-melasma/`; concern `/concerns/redness-rosacea-appearance/`; concern `/concerns/pores-congestion/`; concern `/concerns/dehydration-barrier/`; comparison `/compare/advanced-skin-imaging-vs-visual-consultation/`; guide `/guides/what-advanced-skin-imaging-shows/`; (decision) Sanity `service` doc for skin analysis |
...
| **Skin analysis as a `service`** | `advanced-skin-imaging.md` | Exists only as the `/skin-analysis/` **singleton**, not a `service` doc — needs a decision on whether to make it a first-class service (would gain service listing + JSON-LD). Positioned as complimentary; no price. |
