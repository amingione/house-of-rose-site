# Procell Microchanneling — Branded Context Note

**Status:** Merged into the canonical Microneedling research brief on 2026-08-06.

House of Rose does not treat microchanneling and microneedling as separate service categories. The generic service name is **Microneedling**. When the Procell brand, device system, manufacturer materials, or Pro/MD materials are in context, use **Procell Microchanneling**.
