...
6. **Compliance sweep** (independent subagent): grep `dist/` + Sanity drafts for every
   ...
   `book@`, `7376`, `33982`, `Ste`/`Suite`, "day spa", membership language. Zero hits.
...
9. **Fact-check pricing**: every price shown on a page traces to `docs/services/pricing/**`,
   `docs/services/Diana/**`, or a Sanity doc. List any untraceable price as P0.

## Wrap-up

- `docs/research/_qa-report.md`: each gate, evidence (command output summaries, counts),
