...
3. **Never write "dermatologist" in copy.** Bidding the keyword is defensible; the word in an ad or on a
   page implies a specialty not held. Same for "skin doctor" and "dermatology specialists."
4. **Turn off anything that can rewrite published text** — Google DKI and automatically created assets,
   Meta creative enhancements and text variations. An optimiser that rewrites a paragraph can delete a
   statutory disclosure, and "the platform generated it" is not a defence.
...
Nothing in this directory is legal advice, and nothing in it authorises spend.

---

_Created 2026-07-26. Verified against primary sources on that date; re-verify quarterly._
