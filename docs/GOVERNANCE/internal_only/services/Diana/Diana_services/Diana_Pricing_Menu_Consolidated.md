> ⚠️ **FLAGGED 2026-08-06 — conflicts with a later decision.** This menu lists PRF Under-Eye at $495
> (series $1,350) and PRF Facial Rejuvenation at $595 (series $1,650) as "final... ready to publish."
> But `PRF_Pricing/FINAL-PRICING.md`, dated 2026-07-20 and marked "Amber gave final pricing say for
> this pass," raised those to $550/$1,485 and $650/$1,750. No date stamp on this file makes it
> impossible to tell whether it predates or postdates that raise. Live GlossGenius (pulled 2026-08-06)
> shows PRF Under-Eye at the **old** $495 — so either the raise was never implemented, or this
> undated menu is actually the newer, correct decision and the raise was reconsidered. **This needs a
> direct answer from Amber/Diana, not an assumption** — see
> `docs/GOVERNANCE/internal_only/services/ALL-SERVICES-PRICING.MD` § Open items, item 2. GLP-1
> ($225+/mo Semaglutide, $325+/mo Tirzepatide) and IV pricing below also don't match the current
> GlossGenius export (Semaglutide $299, Tirzepatide $399, IV $99–$185 across six named drips) — same
> caveat applies to every number in this file.
