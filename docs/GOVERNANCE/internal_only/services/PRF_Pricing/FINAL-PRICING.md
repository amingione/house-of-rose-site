> 🔴 **DECISION NEVER IMPLEMENTED — flagged 2026-08-06.** This file records Amber's 2026-07-20 approval
> to raise PRF Under-Eye $495→$550 (series $1,485) and PRF Facial (1 area) $595→$650 (series $1,750),
> with an explicit instruction to update GlossGenius first. A fresh GlossGenius export pulled 2026-08-06
> — roughly three weeks later — still shows PRF Under-Eye at **$495**, and there is no clearly matching
> "PRF Facial Rejuvenation (1 Area)" line in GlossGenius at all (only "PRF Microneedling Consultation"
> $595, which by naming may actually be Amber's *topical* PRF Skin Renewal, not this *injectable*
> service). This needs Amber/Diana to either push the raise live in GlossGenius now, or confirm the
> raise was reconsidered and this file should be marked abandoned. See the reconciliation notes in
> `docs/GOVERNANCE/internal_only/services/ALL-SERVICES-PRICING.MD` § Open items, item 2.
