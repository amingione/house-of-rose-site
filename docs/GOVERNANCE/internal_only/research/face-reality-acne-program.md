...
**Plain English.** Most stubborn breakouts aren't solved by one good facial — they come back because the skin keeps making the conditions for congestion. The Face Reality method treats the *whole picture over time*: (1) a **customized home-care regimen** you use every day, (2) **biweekly in-studio treatments** to accelerate progress and keep the skin moving, and (3) **coaching** — you and Amber remove pore-clogging products, identify triggers, and adjust the routine as your skin adapts. The commitment and consistency *are* the mechanism; the products and treatments only work if the routine is followed.
...
- **Purging is expected, temporary, and normal.** As exfoliation speeds cell turnover, congestion already forming under the surface can come up faster — a **"purge"** that can look like more breakouts in the first few weeks before things settle. It's part of the process, not a sign of failure; the program's structure is designed to carry clients through it.
...
- **Not every client is a candidate.** Final candidacy is confirmed by the licensed provider at consultation, and **individual outcomes vary.**

---

## 4. The visit

**Program structure (the Acne Bootcamp — 12 weeks, biweekly).** *(Program facts per local docs + Face Reality methodology; provider adapts to the individual.)*

1. **Consultation & skin analysis (visit 1).** Visual and hands-on skin analysis; the specialist grades the breakouts, reviews likely triggers, and teaches you how to read product ingredient lists. Baseline photos for progress tracking (with consent). The first session usually also includes a cleanse/exfoliation, extractions, LED, and hand-off of your **initial ~4-week home-care regimen** with personalized instructions.
2. **Home care (daily, every day between visits).** A personalized set of Face Reality products chosen for your acne type, skin type, skin tone, sensitivity, and environment — used exactly as instructed. This is the part that does most of the work.
3. **Biweekly in-studio visits (every 2 weeks).** Double cleanse → enzyme treatment or **acne peel** → expert extractions → high-frequency and/or **LED**. The specialist checks progress and **adjusts the home-care regimen** for the next two weeks.
4. **Coaching throughout.** Ongoing removal of pore-clogging products, trigger guidance, and reassurance through the purge phase.

**Sensation & downtime.** Treatments are non-invasive; expect mild tingling from actives, brief redness, and some sensitivity after extractions. There's little to no formal "downtime," but the **first few weeks can look worse before better** (the purge). Home-care actives can cause temporary dryness or flaking, which the specialist dials in.

**Results timeline.** Face Reality's method is designed to show **visible improvement within roughly 6–8 weeks**, with more meaningful clearing over **3–6 months** depending on acne type and — above all — consistency with home care. *(Timeline per Face Reality; individual outcomes vary; we do not promise a result or timeframe.)*
...
**The structured Face Reality program vs. one-off acne facials/peels.**
...
- **Retail follow-through (Face Reality brand, in our shop):** the home-care regimen *is* the retail. Real products in Sanity (`/shop/[slug]/`) the specialist may build a routine from — always specialist-selected, never self-prescribed:
  ...
  - **Acne meds:** 2.5% / 5% / 10% Advanced Acne Med (benzoyl peroxide).
  - **Support / barrier / hydration:** Barrier Care Gel Cream, clearDerma Moisturizer, hydraBalance Gel, hydraRemedy Gel Serum, Clear Skin Restore, Clear Skin Balance, Calming/Soothing/Glycolic-Lactic toners.
  - **Marks & brightening:** glowTone Corrective Serum, Brighten-C Mask (for the appearance of post-breakout discoloration).
  - **Spot support:** invisiClear Hydrocolloid Spot Patches.
- **Not a pairing:** injectables/PRF injections (Diana's lane) are unrelated to the acne program; keep them separate.
...
- **A certified specialist, not a generic facial.** Amber is a **Face Reality Certified Acne Specialist** — the program is delivered by someone trained in the specific method, in Punta Gorda / Charlotte County.
- **A plan, not a one-off.** The value is the **structure**: biweekly adjustment, a home-care routine that evolves, and coaching on triggers and pore-clogging products. That's what actually moves persistent breakouts — and it's rare in a small-market spa.
- **Honest about the line.** We refer out for severe/cystic acne and coordinate with medical care rather than overpromising. That honesty is a feature.
- **Clear, next-step pathways.** Once skin is calmer, the same studio offers **BioRePeel** and **microneedling** for the *appearance of* acne scarring — a genuine "clear, then refine" journey under one roof.
- **The retail closes the loop.** Face Reality home care is stocked in our shop, so the routine the specialist builds is available and supported — no scavenger hunt.
- **No overclaiming.** We talk about the **appearance of breakouts** and **clearer-looking, calmer skin**, we say individual outcomes vary, and we're upfront that the result depends on your commitment.
...
**Web sources (mechanism/method/candidacy only — no prices, no medical claims imported):**
