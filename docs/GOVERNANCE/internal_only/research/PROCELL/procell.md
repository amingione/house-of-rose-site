...
**Are the growth factors injected into my skin?**
No. The serum is applied topically during the microchanneling protocol; the channels help it absorb at the surface. Microneedling devices are not authorized to deliver products or blood into the skin, and we never describe it that way.
...
- https://Procelltherapies.com/ — manufacturer overview: microchanneling mechanism (thousands of channels stimulate the skin's renewal process), serum-as-conduit framing.
- Manufacturer social (Procell Therapies FB/IG, Sep 2024) — corroborates "MD provides faster results with shorter recovery times" and "MD = twice the growth factors of Pro"; used only to confirm the tier positioning already in local docs, not for claims.
