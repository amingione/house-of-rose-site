...
## 2. How it works — retail as treatment follow-through

**Plain English.** A professional treatment (microchanneling, a peel, an acne session, a facial) does the heavy lifting in one visit; the skin then remodels, calms, or clears over the following weeks. What you use at home during that window decides how much of the result holds. "Retail follow-through" means each brand we stock maps to a treatment or a concern the provider is already addressing — so the home regimen is a continuation of the plan, not a random shelf purchase.
...
## 3. Who each brand is for / hero categories / treatments supported

Organized per brand (the charter's §1–§4 collapsed into one per-brand capsule, since this is a multi-brand brief). Each capsule: **positioning · who it's for · hero categories · treatments it supports as aftercare · retail follow-through.**

### 3.1 GlyMed+ (`glymed`) — 75 products, the largest line

- **1-line positioning:** Pharmaceutical-grade clinical skincare for corrective, results-driven regimens — the "prescriptive" line for concern-specific correction.
- **Who it's for:** Clients who want a structured, corrective daily regimen — aging-skin-appearance concerns, pigment/tone, congestion/oil, sensitivity/barrier repair, and pre/post-procedure support. Skews toward the client who wants the most clinical, layered routine and is guided by the provider.
- **Hero categories (4):** (1) **Corrective serums** (Vitamin C Serum, Retinol Rejuvenation Serum, peptide serums); (2) **Barrier & recovery** (Barrier Repair Cream with Amino Acids, Recovery Cream with Arnica, Comfort Cream); (3) **Pre-/Post-Procedural kits** (Pre-Procedural Essentials Kit, Post-Procedural Essentials Kit); (4) **Daily protection & cleansing** (Oil-Free Protective Moisturizer SPF range, salicylic/glycolic cleansers).
- **Treatments it supports as aftercare:** the widest reach — **Microneedling and eligible topical-PRF adjunct recovery** (Recovery Cream with Arnica, Post-Procedural kit, Skin Recovery Mist), **peels/BioRePeel** (barrier repair, comfort creams, SPF), **daily regimen** for laxity/pigment/sensitivity between any facial. Its Pre-Procedural kit is a *pre*-treatment prep sale.
- **Retail follow-through:** GlyMed+ is the provider's toolkit for "what do I use every day to keep correcting." Post-procedure clients often leave with the Post-Procedural Essentials Kit; laxity/pigment clients build a serum + SPF regimen.
- **Founder/story anchor (web-confirmed):** founded by Christine Heathman, a corneotherapy/clinical-treatment authority; positioned as pharmaceutical-grade, esthetician-dispensed.
...
- **Retail follow-through:** the "everyday professional care" default and the natural first professional purchase — travel kits and intro kits (Discovery Kit, Cosmo Intro Kit) are low-commitment entry buys.
- **Story anchor (web-confirmed):** chirally-correct formulations, award-winning enzymes, made in USA, 100% employee-owned; positioned as pro-grade skincare "made accessible."

### 3.3 Face Reality (`face-reality`) — 30 products

- **1-line positioning:** A dedicated acne-clearing home-care system that is inseparable from a certified acne-program protocol — the products *are* the program's home half.
- **Who it's for:** Clients with active acne (any grade) enrolled in — or building toward — the Acne Program; oil/congestion-prone skin; bacne/body-acne clients (Back Treatment). Not a general-glow line; it's condition-specific and provider-directed.
- **Hero categories (3):** (1) **Acne meds & exfoliating serums** (Advanced Acne Med 2.5/5/10%, L-Mandelic 5–15%, Glycolic serums); (2) **Cleansers & toners** (Acne Face & Body Wash/Scrub, Ultra Gentle Gel Cleanser, Glycolic-Lactic Toner, Calming/Soothing toners); (3) **Barrier & repair** (Barrier Balance Creamy Cleanser, Barrier Care Gel Cream, hydraBalance/hydraCalm, invisiClear Hydrocolloid Spot Patches).
- **Treatments it supports as aftercare:** **the Face Reality Acne Program / Acne Bootcamp** (`/services/face-reality-acne-program/`, `/services/acne-bootcamp/`), **Acne Peel** and **Back Treatment**. Amber Mingione is a **Face Reality Certified Acne Specialist** — a real, citable credential (not a "clinically proven" outcome claim).
...
- **Story anchor (web-confirmed):** clean, cruelty-free, non-comedogenic mineral makeup with skincare benefits (zinc-oxide sun protection); positioned as makeup that lets skin "breathe and function normally."
...
4. **Checkout & fulfillment** — Stripe payment → Sanity `order` doc → Resend confirmation → provider buys the Shippo label manually (`buyLabel`), never auto-purchased.

**Current state (honest):** `promotion` docs = 0, `shopBrand` docs = 0, `isFeatured` products = 0, `purchaseUrl` = 0. The page degrades gracefully (no promo banner, fallback brand copy, no Top Sellers rail) but the brand storytelling and merchandising levers are all unused. See GAPS.

---

## 5. Comparisons — brand vs brand, and professional vs drugstore

### 5.1 Skin Script vs GlyMed+ (the daily-regimen decision)
Both build a daily corrective regimen; the honest split is **depth vs accessibility**.

| | **Skin Script Rx** | **GlyMed+** |
|---|---|---|
| Positioning | Accessible, chirally-correct, enzyme-forward pro care | Pharmaceutical-grade, clinical, prescriptive correction |
| Best for | First professional regimen; maintenance; everyday brightening/hydration; value-conscious | Layered corrective routines; pre/post-procedure kits; the most clinical daily plan |
| Line depth | 52 SKUs, strong enzymes/kits | 75 SKUs, deepest corrective + procedural range |
| When it wins | Client wants effective pro care without the top price rung, or is stepping up from drugstore | Client wants maximum correction, procedural support, and a provider-built layered plan |

**Rule of thumb:** start most clients on **Skin Script** for an approachable, effective daily routine; move to (or blend in) **GlyMed+** when the concern is corrective, procedural, or the client wants the most clinical regimen. The provider decides.
...
## 6. Concern mapping — hero products → concerns (retail follow-through)
...
| **`acne-scarring`** | corrective serums as adjunct | Mandelic Brightening, L-Mandelic exfoliation | acne meds, L-Mandelic serums, spot patches | post-corrective needling aftercare | — |
| **`stretch-marks`** (body) | barrier/recovery for body work | — | — | body-channeling aftercare | Smooth Ritual Polish |
| **`dark-circles`** | Eye Calm, Firming Eye Cream | Peptide Eye Serum | Antioxidant Peptide Eye Gel | — | — |
| **`hair-thinning`** | — (scalp/PRF lane is Diana's) | — | — | — | — |
...
## 7. Pairings & pathways — retail follow-through by treatment

The single most important table in this brief: **treatment → matched retail brand(s).**
...
| **Face Reality Acne Program / Acne Bootcamp** | **Face Reality** adaptive home care (program-dispensed) | — (condition-specific) |
...
## 8. Cost factors — what moves retail price (Sanity only)

All retail prices come from **Sanity** (cents→USD). No web prices.
...
**Which brand is right for my daily routine — Skin Script or GlyMed+?**
...
**What's in the House of Rose line?**
A small line of everyday rituals — a mineral SPF, a body/skin polish, and a coconut oil — designed as simple, gift-able daily care and an easy way to take a piece of House of Rose home. It supports, rather than corrects.

**Will these products clear my acne / erase my wrinkles?**
No product is a cure or a guarantee. Professional home care is designed to *support* your treatment results and the *appearance* of clearer, smoother, more even-looking skin over time. Outcomes are individual and depend on your skin and consistency.

**How do I actually buy — online or in studio?**
Both. Your provider selects your regimen in studio, and you can purchase there or through our online shop, which ships to you. Prices are confirmed from our current catalog at checkout.

**Are these products safe to layer with my prescription skincare?**
...
**Product-name compliance — the critical flag (open owner decision, logged in Phase 1).**
Several **real manufacturer product names** contain banned terms. These are the products' actual names and must stay accurate for buyers to identify them — **do NOT rename them**. But our own descriptive/marketing copy *around* them must never adopt the banned framing:

| Real product name (keep as-is) | Brand | Banned term in the name |
|---|---|---|
| **Age Defying Masque** | GlyMed+ | "age-defying" |
| **Anti-Aging Exfoliant Masque** | GlyMed+ | "anti-aging" |
| **Age Delay Cream** | GlyMed+ | "age delay" (age-reversal framing) |
| **Firming Serum with Phyto-Stem Cells** | GlyMed+ | "stem cell" |
| **Ageless Skin Moisturizer / Ageless Skin Hydrating Serum / Ageless Lip Treatment** | Skin Script | "ageless" (age-reversal adjacent) |

**Open owner decision (Amber's call, per `phase1-open-followups.md` #3):** keep accurate manufacturer names as-is, **or** add a compliant *display label* layer (accurate name shown small/secondary, House of Rose descriptive copy leading). Not renamed unilaterally. Whatever is chosen, **our surrounding copy** (product descriptions, category headers, brand blurbs, meta) must say "for the appearance of the visible signs of aging," "supports skin longevity," "firming-type" — never "anti-aging," "stem cell," "age-defying," "reverse."

**Phrases to avoid for THIS topic specifically:**
- "Anti-aging," "age-defying," "reverse aging," "turn back the clock," "ageless results" — in *our* copy (even though products carry the words).
- "Stem cell" as a claim or benefit (the GlyMed+ Phyto-Stem Cells serum name is the only place the phrase appears — never build a claim on it).
...
- `docs/internal_only/COMPLIANCE-COPY-RULES.md` — binding never-say / say-instead table, required guardrails, med-spa "allow don't lead."
...
- https://glymedplus.com/founder — manufacturer; Christine Heathman / corneotherapy positioning, "pharmaceutical grade" clinical brand.
- https://www.instagram.com/skinscriptrx/ + Skin Script brand posts — manufacturer; "chirally correct," award-winning enzymes, made in USA, 100% employee-owned, "made accessible."
- https://facerealityskincare.com/ — manufacturer; certified acne program, personalized at-home routine. (Their "Clinically Proven Visible Results in 8 weeks" and "treats [acne grades]" framing was deliberately NOT imported — see §10.)
- https://janeiredale.com/ + Mineral Makeup FAQ — manufacturer; clean, cruelty-free, non-comedogenic mineral makeup with skincare benefits (zinc-oxide sun protection), "lets skin breathe."
