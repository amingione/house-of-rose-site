...
This file is a decision system, not a scrapbook. It should help an agent answer:

- Who are we speaking to, and what is happening in their world?
- What outcome do they want, what blocks them, and what do they already believe?
- What does the brand promise, and why should someone believe it?
- Which offer, message, proof, and call to action fit this stage and channel?
- What must the copy sound like—and what must it never sound like?
- What has already been tried, approved, rejected, or learned?
- How does each fact affect downstream creative decisions?

### Evidence states

Every substantive addition should carry one of these labels:

- `[VERIFIED]` — supported by an authoritative source or confirmed by the user.
- `[DECIDED]` — an explicit strategic or creative choice currently in force.
- `[OBSERVED]` — directly present in customer language, research, or results.
- `[INFERRED]` — a reasonable working interpretation that still needs validation.
- `[TESTING]` — an active hypothesis being tested.
- `[SUPERSEDED]` — retained for history but no longer governing current work.
- `[UNKNOWN]` — important information that has not been supplied or established.

Never promote an inference to a fact without evidence. Never place an
unverified product, performance, health, financial, scarcity, testimonial, or
comparative claim in published copy.

### Source priority

When sources disagree, use this order unless the user explicitly directs
otherwise:
...
decisions, proof, patterns, constraints, approved language, performance lessons,
and the reasoning that connects them.

Do not store passwords, API keys, private customer data, regulated personal
information, raw transcript dumps, or every version of a draft. Link to source
material when it exists and summarize only what is reusable.

---

## 2. Executive brand snapshot

Agents should be able to read this section and understand the brand in under a
minute. Populate it only with verified or explicitly decided information.
...
> For **[specific audience]** who **[high-value struggle or desire]**, **[brand]**
> is the **[category/frame]** that helps them **[valuable outcome]** through
...
|---|---|---|---|---|
| `[UNKNOWN: customer reality]` | `[What it means]` | `[What we should communicate]` | `[Hook, format, offer, CTA, or experience]` | `[UNKNOWN]` |
...
Strong brands often balance two useful qualities. Define the desired balance so
copy does not flatten the brand into a single generic trait.

| Tension | We balance it by… | Failure on the left | Failure on the right |
|---|---|---|---|
| Expertise ↔ accessibility | `[UNKNOWN]` | Cold, dense, intimidating | Shallow, vague, unserious |
| Aspiration ↔ credibility | `[UNKNOWN]` | Flat, purely functional | Hype, fantasy, overclaiming |
| Consistency ↔ freshness | `[UNKNOWN]` | Repetitive, invisible | Off-brand, trend-chasing |
| Urgency ↔ trust | `[UNKNOWN]` | No reason to act | Pressure, false scarcity |
...
Values only become useful when they govern choices.
...
- **What we believe about the customer:** `[UNKNOWN]`
- **What we believe about the category:** `[UNKNOWN]`
- **What conventional wisdom we challenge:** `[UNKNOWN]`
- **What should never need to change about us:** `[UNKNOWN]`
- **The “enemy” or unhelpful status quo—not a person:** `[UNKNOWN]`

---

## 5. Audience memory

Do not reduce audiences to demographics when motivations, context, or behavior
are more predictive. Preserve the customer's own words whenever possible.

### Primary audience

| Dimension | Current understanding | State / source |
|---|---|---|
| Who they are | `[UNKNOWN]` |  |
| Situation / trigger | `[UNKNOWN]` |  |
| Job they are trying to do | `[UNKNOWN]` |  |
| Desired functional outcome | `[UNKNOWN]` |  |
| Desired emotional outcome | `[UNKNOWN]` |  |
| Desired social outcome | `[UNKNOWN]` |  |
| Current pain / friction | `[UNKNOWN]` |  |
| Stakes of doing nothing | `[UNKNOWN]` |  |
| Existing alternatives | `[UNKNOWN]` |  |
| Objections / anxieties | `[UNKNOWN]` |  |
| Buying criteria | `[UNKNOWN]` |  |
| Trust signals | `[UNKNOWN]` |  |
| Misconceptions | `[UNKNOWN]` |  |
| Words they use | `[UNKNOWN]` |  |
| Words they avoid | `[UNKNOWN]` |  |

### Audience segments

| Segment | Distinguishing need | Awareness | Best promise | Best proof | Best offer / CTA | Avoid |
|---|---|---|---|---|---|---|
| `[UNKNOWN]` |  |  |  |  |  |  |

### Awareness states

| State | What the audience believes | Message job | Suitable CTA |
|---|---|---|---|
| Unaware | They do not yet name the problem | Reveal a recognizable tension without forcing the sale | Learn / notice / explore |
| Problem-aware | They feel the problem but may not know solutions | Clarify stakes and show a better possibility | Discover the approach |
| Solution-aware | They know solution categories | Explain the mechanism and differentiation | Compare / see how it works |
| Product-aware | They know the brand or offer | Resolve objections with proof and fit | Start / book / buy / try |
| Most aware | They are close to acting | Make the offer and next step unmistakable | Direct response CTA |

**Current priority awareness state:** `[UNKNOWN]`
...
Never make an external comparative claim unless it is verified and permitted.

| Alternative | Why customers choose it | Where it falls short | Our relevant advantage | Proof | Claim-safe? |
|---|---|---|---|---|---|
| `[UNKNOWN]` |  |  |  |  | No—until verified |

---

## 7. Offer and value architecture

### Offer ladder

| Offer | Audience / moment | Outcome | Mechanism / inclusions | Price / terms | Proof | CTA | Status |
|---|---|---|---|---|---|---|---|
| `[UNKNOWN]` |  |  |  |  |  |  | `[UNKNOWN]` |

### Value equation

- **Dream outcome:** `[UNKNOWN]`
- **Perceived likelihood of success:** `[UNKNOWN]`
- **Time to value:** `[UNKNOWN]`
- **Effort / sacrifice required:** `[UNKNOWN]`
- **Risk reversal or reassurance:** `[UNKNOWN]`

### Operational truth

Copy must reflect what the business can actually deliver.
...
| Forma is used only for the appearance of crepey-looking facial texture and to support the skin’s collagen response. | Clients should understand the visible texture concern and treatment mechanism without being promised facial reshaping. | Do not connect Forma to tightening, lifting, sculpting, contouring, firmness, laxity, jowls, a facelift effect, or a more-defined facial shape. | `[DECIDED]` — user direction, 2026-08-06 |
| `[UNKNOWN]` |  |  |  |
...
- **Name of method / mechanism:** `[UNKNOWN]`
- **How it works in plain language:** `[UNKNOWN]`
- **Why it is different:** `[UNKNOWN]`
- **Why it is believable:** `[UNKNOWN]`
- **What must not be implied:** `[UNKNOWN]`

### Objection map

| Objection | What may be underneath it | Best response | Proof needed | Avoid saying |
|---|---|---|---|---|
| `[UNKNOWN]` |  |  |  |  |

### Message hierarchy

Use this priority unless a task-specific brief overrides it:

1. `[UNKNOWN: primary message]`
2. `[UNKNOWN: supporting message]`
3. `[UNKNOWN: proof]`
4. `[UNKNOWN: offer]`
5. `[UNKNOWN: CTA]`
...
## 9. Proof, claims, and trust

The claim ledger is the boundary between persuasive copy and invented copy.
...
| Glo2Facial mechanism and outcome claims (Bohr-effect oxygenation, no downtime, study outcomes) | PubMed-verified 2026-08-11: Diaz et al. 2017, J Clin Aesthet Dermatol (PMID 29399257, PMC5774907) — open-label, 10 patients, six weekly OxyGeneo sessions; all reported improved overall appearance/texture/brightness, 7/10 minor fine-line improvement, 5/10 pigmentation improvement; no downtime reported. The studied protocol included a TriPollar RF step. "No downtime" is the owner-verified exact-procedure exception (`allowNoDowntime` in `publicCopy.ts`). | "Prompts the skin to oxygenate itself (the Bohr effect)"; "no downtime" for this exact service; "in a small published study every patient reported improved overall skin appearance and texture." | Cite as a small 10-patient study with no control group; state that the studied protocol included an RF step the standard House of Rose Glo2Facial does not; fine-line change modest; individual results vary. | RF/skin-tightening/"neocollagenesis" claims for the standalone service; "pumps oxygen into your cells"; "detox"; blanket "pregnancy-safe." | `[VERIFIED]` — PubMed metadata pulled 2026-08-11 during the Glo2Facial page rewrite |
...
| Asset | What it proves | Best audience / stage | Location / source | Usage constraints |
|---|---|---|---|---|
| `[UNKNOWN]` |  |  |  |  |

### Compliance and reputational guardrails

- Never invent testimonials, results, endorsements, statistics, credentials,
  guarantees, stock levels, deadlines, or scarcity.
- Avoid absolute or universal outcomes unless they are explicitly substantiated.
...
## 11. Channel and funnel adaptation

Do not copy-paste the same message into every channel. Preserve the strategy and
adapt the expression.

| Channel | Audience context | Primary job | Voice / format | Proof density | CTA style | Constraints |
|---|---|---|---|---|---|---|
| Paid social | Scrolling, low intent | Earn attention and create qualified curiosity | Fast, specific, native | Light to medium | One clear next step | Platform rules, short attention |
| Search ads | Active intent | Match the query and signal relevance | Direct, concrete | Medium | Intent-matched | Character limits, claim safety |
| Landing page | Evaluating fit | Build a complete case | Scannable, specific, sequenced | High | Repeated and consistent | Message match, speed, accessibility |
| Email | Known contact | Move one relationship step | Personal, focused | Varies | One primary CTA | Consent, deliverability |
| Organic social | Community / discovery | Build recognition and belief | Conversational, recognizable | Light to medium | Engage / save / explore | Native format and cadence |
| Website | Mixed intent | Orient, differentiate, route | Clear and durable | Medium to high | Contextual | Accessibility, SEO, navigation |

**Brand-specific channel rules:** `[UNKNOWN]`

---

## 12. Advertising copy system

### Ad brief required inputs

Before writing ads, resolve or explicitly label each item:

| Input | Selection for current task |
|---|---|
| Campaign objective |  |
| Audience segment |  |
| Awareness stage |  |
...
| Channel / placement |  |
| CTA |  |
| Claim / compliance constraints |  |
| Success metric |  |

### Recommended ad logic

Use the lightest structure that makes the case:

1. **Hook:** Name a relevant tension, desire, contrast, or specific truth.
2. **Bridge:** Connect that truth to the brand's worldview or mechanism.
3. **Value:** Make the outcome concrete and audience-relevant.
4. **Proof:** Supply the most credible evidence available for this stage.
5. **Offer:** State what the person gets and reduce ambiguity.
6. **CTA:** Ask for one proportionate next step.

The structure is not a fixed formula. Awareness stage, placement, and creative
format determine how many elements belong in one ad.

### Hook matrix

Hooks must be derived from known audience or product truth—not manufactured
drama.

| Hook angle | Source truth | Example in brand voice | Best segment / stage | Status |
|---|---|---|---|---|
| Problem recognition | `[UNKNOWN]` | `[UNKNOWN]` |  |  |
| Desired identity | `[UNKNOWN]` | `[UNKNOWN]` |  |  |
| Contrarian insight | `[UNKNOWN]` | `[UNKNOWN]` |  |  |
| Mechanism reveal | `[UNKNOWN]` | `[UNKNOWN]` |  |  |
| Proof / result | `[UNKNOWN]` | `[UNKNOWN]` |  |  |
| Objection reversal | `[UNKNOWN]` | `[UNKNOWN]` |  |  |

### Copy QA for ads

An ad is not ready until all applicable answers are “yes”:

- Does the hook come from a real audience tension or desire?
- Is the intended audience able to recognize themselves without stereotyping?
- Is the promise consistent with the offer and operational reality?
- Is every claim supported in the claim ledger?
- Is the differentiator meaningful rather than merely decorative?
...
## 13. Approved content and copy library

Only store copy that has been explicitly approved or validated. Record why it
works so future agents can adapt the principle without mindlessly repeating the
line.
...
|---|---|---|---|---|
| Positioning Morpheus8 or Lumecca for skin tightening, lifting, laxity, firmness, sagging, jowls, or contouring | It conflicts with the owner's approved treatment lanes. The earlier rationale identifying Forma as a firmness lane is superseded by DEC-003. | Route Morpheus8 to tone, texture, eligible scars, and stretch marks; route Lumecca to visible pigment, uneven tone, and selected texture. | 2026-08-06 / user direction | `[DECIDED]`; prior Forma rationale `[SUPERSEDED]` |
| Positioning Forma for tightening, lifting, sculpting, contouring, firmness, laxity, jowls, a facelift effect, or a more-defined facial shape | These outcomes are outside the owner-approved Forma marketing lane. | Describe Forma only for crepey-looking facial texture and cautious collagen-support language. | 2026-08-06 / user direction | `[DECIDED]` |
| `[UNKNOWN]` |  |  |  |  |

---

## 14. Campaign and experiment memory

Store learnings, not just numbers. Distinguish causation from correlation and
avoid declaring a winner without enough evidence.

### Active campaigns

| Campaign | Objective | Audience | Offer | Core message | Channels | Dates | Owner | Status |
|---|---|---|---|---|---|---|---|---|
| `[UNKNOWN]` |  |  |  |  |  |  |  |  |

### Experiment ledger

| Test ID | Hypothesis | Variable | Control / variants | Primary metric | Result | Interpretation | Durable learning | Confidence |
|---|---|---|---|---|---|---|---|---|
| `[UNKNOWN]` |  |  |  |  |  |  |  |  |

### Performance patterns

| Pattern | Evidence | Likely reason | Where it applies | Next action | State |
|---|---|---|---|---|---|
| `[UNKNOWN]` |  |  |  |  |  |
...
Record decisions with enough reasoning to prevent future agents from reopening
settled questions or repeating rejected approaches.
...
## 16. Contradictions, open questions, and intake queue
...
Answer these before low-level style preferences; they unlock the most useful
downstream work.

1. `[UNKNOWN]` What is the brand name, what does it sell, and where does it sell?
2. `[UNKNOWN]` Who is the highest-priority customer, and what triggers them to look for help?
3. `[UNKNOWN]` What valuable outcome does the brand create, and through what distinct mechanism?
4. `[UNKNOWN]` Which offer is the current commercial priority, with what price, terms, and CTA?
5. `[UNKNOWN]` What proof can be used publicly, and what claims are prohibited or sensitive?
6. `[UNKNOWN]` Which existing materials best represent the desired voice?
7. `[UNKNOWN]` What should the brand never sound like, even if it improves short-term clicks?
8. `[UNKNOWN]` Which channels, markets, funnel stages, and success metrics matter now?
...
## 17. Brand Alignment Gate

Run this gate before delivering any brand-affecting work. A material “no” must
be fixed, explicitly disclosed, or logged as an unresolved risk.

### Strategy

- [ ] The audience and their current situation are clear.
- [ ] The work serves a defined objective and awareness stage.
- [ ] The selected message, offer, and CTA form one coherent path.
- [ ] The deliverable expresses a meaningful brand difference.

### Truth and trust

- [ ] Claims are present in the claim ledger or conservatively qualified.
- [ ] Proof is real, relevant, and used in the right context.
- [ ] The work does not invent urgency, scarcity, testimonials, or outcomes.
- [ ] Operational, legal, compliance, and platform constraints are respected.
...
- [ ] Unknowns and inferences are labeled.
- [ ] Relevant prior decisions, rejections, and learnings were checked.
- [ ] Any durable new decision or learning has been written back.
...
2. Pull the relevant audience, offer, message, proof, voice, channel, and history.
3. Identify unknowns and contradictions.
4. Build the brief from stored truth; do not force the truth to fit a favorite idea.

### During the task

1. Keep facts, decisions, observations, inferences, and tests distinct.
2. Trace recommendations through the Connected-dots Strategy Map.
3. Check claims before using them.
4. Preserve useful customer language and evidence provenance.

### After the task

1. Run the Brand Alignment Gate.
2. Write back only durable knowledge.
3. Update affected sections rather than duplicating the same fact elsewhere.
4. Add a Decision Ledger entry for consequential choices.
5. Add a Change Log entry with the date, sections changed, reason, and source.
6. Update `Last updated`; increment the memory version for meaningful structural
   or strategic changes.

### Version convention

- Patch (`1.0.1`): wording, source, clarification, or small learning.
- Minor (`1.1.0`): new confirmed strategy, offer, audience, voice, or campaign layer.
- Major (`2.0.0`): foundational repositioning or incompatible brand direction.

### Anti-regression rule

Before changing an established choice, locate its Decision Ledger entry and
source. If the change is legitimate, mark the old entry `[SUPERSEDED]`, add the
replacement, and document downstream sections that need updating. Never erase
the reasoning trail merely to make the file look tidy.
