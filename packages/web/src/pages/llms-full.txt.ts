...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines: string[] = [
    ...
    `- Facebook: https://www.facebook.com/people/House-Of-Rose-Aesthetics/`,
    ``,
    `---`,
    ``,
    `## Site Pages`,
