...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines: string[] = [
    ...
    `- **The Rose Circle** (${base}/rose-circle/): 6-month guided client affiliation built on the Rose Method's four phases (Reveal, Regenerate, Restore, Sustain), at member rates — this is not a membership`,
    `- **Memberships** (${base}/memberships/): Recurring membership plans — Rose Pass (wax membership), IV Hydration Membership, and the Rose Collagen Bank`,
