...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines: string[] = [
    ...
    ``,
    `House of Rose is located at 525 E Olympia Ave, Unit 9, Punta Gorda, FL 33982. Phone: (844) 941-7673. Email: book@houseofrosefl.com. Serving Charlotte County and Southwest Florida including Port Charlotte, Englewood, Venice, Sarasota, and Cape Coral.`,
    ``,
    `## Core Pages`,
    ``,
