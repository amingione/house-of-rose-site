...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines: string[] = [
    ...
    ``,
    `House of Rose is located at 525 E Olympia Ave, Ste 9, Punta Gorda, FL 33950. Phone: (844) 941-7376. Email: info@houseofrosefl.com. Serving Charlotte County and Southwest Florida including Port Charlotte, Englewood, Venice, Sarasota, and Cape Coral.`,
    ``,
    `## Core Pages`,
    ``,
