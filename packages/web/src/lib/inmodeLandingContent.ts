...
const platformPathways: readonly InModePathway[] = [
  ...
  },
  {
    ...
    concerns: ['Mild laxity', 'Firmness', 'Smoothness', 'No downtime'],
...
export const INMODE_LANDING_CONTENT = {
  inmode: {
    ...
    heroImage: {
      src: '/images/editorial/skin-analysis/skin-texture-study-v1-1536.webp',
      alt: 'Close facial view showing natural skin texture, fine lines, and visible pigmentation',
      width: 1536,
      height: 961,
    },
    ...
    faqs: [
      ...
      { question: 'Which InMode treatment has no downtime?', answer: 'Forma is the non-invasive RF option and does not require a recovery period. Lumecca Peak can cause temporary warmth, redness, or darkening of pigment, while Morpheus8 requires a planned recovery window.' },
  ...
  morpheus8: {
    ...
    opening: {
      ...
      deviceImage: {
        ...
        width: 628,
        height: 1000,
        credit: 'InMode manufacturer media',
      },
    },
    ...
    results: {
      ...
      intro: 'This manufacturer-provided four-treatment example is presented at a size that allows the lower-face texture and contour to be compared. It is not a prediction of an individual outcome.',
  ...
  'lumecca-peak-ipl': {
    ...
    heroImage: {
      src: '/images/optimized/hor-skin-studio-1400.webp',
      alt: 'House of Rose skin treatment studio in Punta Gorda, Florida',
      width: 1400,
      height: 1050,
    },
  ...
  'forma-rf-facial': {
    ...
    metaDescription: 'Forma radiofrequency facial in Punta Gorda for smoother-looking skin, mild laxity, facial firmness, and no-downtime maintenance.',
    eyebrow: 'Forma / Forma Plus RF · Punta Gorda',
    title: 'Radiofrequency skin maintenance without a recovery window.',
    ...
    heroNote: 'Non-invasive · Temperature monitored · No downtime',
    ...
    quickFacts: [
      ...
      { label: 'Recovery', value: 'No downtime' },
    ],
    opening: {
      ...
      paragraphs: [
        ...
        'The result is a treatment designed for skin quality, smoothness, and mild firmness concerns without a visible recovery period. It is a distinct strategy, not a weaker version of Morpheus8.',
      ],
      points: [
        ...
        { title: 'Repeatable maintenance', text: 'The no-downtime format can fit an ongoing skin-quality plan when appropriate.' },
      ],
      deviceImage: {
    ...
    concerns: ['Mild facial laxity', 'Loss of firmness', 'Early visible aging', 'Smoother-looking skin', 'Facial contour appearance', 'Collagen support', 'Ongoing skin maintenance', 'A no-downtime treatment preference'],
    comparison: {
      ...
      columns: [
        { title: 'Forma', subtitle: 'Non-invasive RF', points: ['No needles', 'Continuous surface-temperature monitoring', 'No downtime', 'Maintenance and mild-to-moderate concern strategy'] },
    ...
    results: {
      ...
      intro: 'Forma is often selected for gradual skin-quality and firmness goals. These manufacturer examples are shown large enough to compare the lower face and neck without presenting them as House of Rose outcomes.',
    ...
    timeline: {
      ...
      intro: 'Forma does not require downtime, but a no-downtime treatment can still be gradual. The number and spacing of sessions should come from the plan, not from a universal package formula.',
      steps: [
    ...
    approach: {
      ...
      paragraphs: [
        'A no-downtime option should not be sold as the answer to every degree of laxity. House of Rose begins with the amount and location of change you are noticing, then distinguishes a Forma maintenance plan from the more intensive fractional work Morpheus8 can provide.',
    ...
    formaPlus: {
      ...
      forma: 'Forma is the smaller applicator used for facial and other compact treatment areas. This page focuses on face, jawline, and neck skin quality.',
      plus: 'Forma Plus is the larger applicator available on the OptimasMAX platform. Its size changes the surface area it can cover; this page remains focused on facial, jawline, and neck skin quality.',
    },
    combinations: [
      platformCombinations[1],
      platformCombinations[2],
    ...
    faqs: [
      ...
      { question: 'What is the difference between Forma and Forma Plus?', answer: 'Forma is the smaller handpiece for compact areas such as the face. Forma Plus has a larger treatment surface. House of Rose positions this page around facial, jawline, and neck skin quality.' },
