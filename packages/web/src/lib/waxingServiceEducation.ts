  ...
  waxing: {
    ...
    distinctions: [
      ...
      },
      {
        ...
        text: 'Body waxing is available for the underarms, bikini line, chest, back, full leg, partial leg, and full arm. Each area has its own price and appointment length.',
      },
    ],
    faqs: [
      {
    ...
    links: [
      {
        ...
        label: 'Meet Brandy, Licensed Esthetician for Facial Waxing',
      },
    ],
  },
  'facial-waxing': {
