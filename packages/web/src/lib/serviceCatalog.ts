...
const PROVIDERS = {
  ...
  'provider-aundrea': {
    ...
    profileSlug: 'aundrea',
    profileImagePath: '/images/providers/aundrea-profile-1122.webp',
...
const SERVICE_RECORDS: readonly ServiceRecord[] = [
  {
    _id: 'service-inmode-optimasmax', title: 'InMode OptimasMAX Treatments', slug: 'inmode', kind: 'hub', public: true, order: 0, collectionSlug: 'inmode', bookingMode: 'consultation', bookingVerifiedAt: '2026-08-27', concernSlugs: ['aging', 'fine-lines-laxity', 'sun-damage', 'hyperpigmentation', 'texture', 'acne-scarring'], relatedSlugs: ['morpheus8', 'lumecca-peak-ipl', 'forma-rf-facial'], _updatedAt: '2026-08-27T00:00:00Z',
  },
  {
  ...
  {
    _id: '99566c9c-8033-4df6-b5a3-ac5de5d2d886', title: 'IV Hydration Therapy', slug: 'iv-hydration-therapy', kind: 'standalone', public: true, order: 1, collectionSlug: 'iv-hydration-therapy', providerId: 'provider-diana', providerScope: RN_SCOPE, duration: '30–45 minutes', bookingMode: 'phone', bookingVerifiedAt: '2026-08-04', gallery: [{ src: '/images/optimized/actual-iv-suite-1400.webp', alt: 'IV hydration suite at House of Rose Aesthetics in Punta Gorda, Florida', width: 1400, height: 1750 }], _updatedAt: '2026-08-27T00:00:00Z',
  },
  {
    _id: 'service-morpheus8', title: 'Morpheus8 RF Microneedling', slug: 'morpheus8', kind: 'standalone', public: true, order: 1, collectionSlug: 'inmode', providerScope: ESTHETICS_MEDICAL_SCOPE, bookingMode: 'consultation', bookingUrl: 'https://houseofrose.glossgenius.com/book?service_token=1000f-6156b30d-84a3-4d71-8d9d-6ee81fea44de', bookingVerifiedAt: '2026-08-04', concernSlugs: ['texture', 'acne-scarring', 'fine-lines-laxity', 'aging'], relatedSlugs: ['lumecca-peak-ipl', 'forma-rf-facial'], evidenceMedia: [inModeEvidence('morpheus8-device', 'device', 'Morpheus8 Burst Technology', 'The Morpheus8 handpiece combines controlled microneedling with fractional bipolar radiofrequency. Treatment depth, energy, and area are selected for the individualized plan.', 'Image courtesy of InMode', 'Morpheus8 Burst radiofrequency microneedling handpiece', '/images/inmode/morpheus8-burst-device.webp', 628, 1000)], _updatedAt: '2026-08-27T00:00:00Z',
  },
  {
    _id: '7bd92dc1-9ced-42bd-a195-e9fa4628a848', title: 'Neurotoxin Injections', slug: 'injectables', kind: 'treatment', public: true, order: 1, collectionSlug: 'injectables-bio-fillers', parentSlug: 'injectables-bio-fillers', providerId: 'provider-diana', providerScope: RN_SCOPE, duration: '30 minutes', bookingMode: 'consultation', bookingUrl: 'https://houseofrose.glossgenius.com/book?service_token=1000f-83af2d65-620f-416b-b1d6-7921d52d249d', bookingVerifiedAt: '2026-09-02', concernSlugs: ['fine-lines-laxity', 'aging'], relatedSlugs: ['microneedling', 'iv-hydration-therapy'], _updatedAt: '2026-08-27T00:00:00Z',
  },
  {
  ...
  {
    _id: 'service-facial-waxing', title: 'Facial Waxing', slug: 'facial-waxing', kind: 'treatment', public: true, order: 60, collectionSlug: 'waxing', parentSlug: 'waxing', providerId: 'provider-brandy', duration: '10–30 minutes by area', bookingMode: 'direct', bookingUrl: 'https://houseofrose.glossgenius.com/book?service_token=1000f-5e8fc55d-9118-49d2-8d24-2e05df90e851', bookingVerifiedAt: '2026-08-04', _updatedAt: '2026-08-27T00:00:00Z',
  },
  {
    _id: '8f3a3755-2633-4bfc-9b04-41696ffba1e1', title: 'Body Waxing', slug: 'body-waxing', kind: 'treatment', public: true, order: 61, collectionSlug: 'waxing', parentSlug: 'waxing', duration: '10–40 min by zone', bookingMode: 'phone', bookingVerifiedAt: '2026-08-12', _updatedAt: '2026-08-27T00:00:00Z',
  },
  {
    _id: 'f5308b9c-73df-4812-8c0d-afcf4ee5839a', title: 'Microneedling', slug: 'microneedling', kind: 'hub', public: true, order: 110, collectionSlug: 'facials', providerId: 'provider-amber', providerScope: ESTHETICS_MEDICAL_SCOPE, bookingMode: 'consultation', bookingUrl: 'https://houseofrose.glossgenius.com/book?service_token=1000f-8ece05f1-16d4-426f-9c06-a4a2d33cd2ac', bookingVerifiedAt: '2026-09-02', concernSlugs: ['aging', 'acne-scarring', 'fine-lines-laxity', 'sun-damage', 'texture', 'stretch-marks', 'hyperpigmentation'], relatedSlugs: ['biorepeel', 'glo2facial', 'dermaplaning'], _updatedAt: '2026-08-27T00:00:00Z',
  },
  {
    _id: 'service-morpheus8-body', title: 'Morpheus8 Body', slug: 'morpheus8-body', kind: 'treatment', public: true, order: 112, collectionSlug: 'inmode', parentSlug: 'morpheus8', providerScope: ESTHETICS_MEDICAL_SCOPE, bookingMode: 'consultation', bookingUrl: 'https://houseofrose.glossgenius.com/book?service_token=1000f-bd506885-7ad3-4a15-ab5a-90a8bd082db4', bookingVerifiedAt: '2026-08-04', concernSlugs: ['stretch-marks', 'texture'], relatedSlugs: ['morpheus8', 'forma-rf-facial'], evidenceMedia: [inModeEvidence('m8b-device', 'device', 'Morpheus8 Body Technology', 'The Morpheus8 handpiece delivers fractional bipolar radiofrequency through microneedles. On the body, depth and energy are set for larger areas and thicker skin.', 'Image courtesy of InMode', 'Morpheus8 Burst radiofrequency microneedling handpiece', '/images/inmode/morpheus8-burst-device.webp', 628, 1000)], _updatedAt: '2026-08-27T00:00:00Z',
  },
  {
  ...
  {
    _id: 'service-prf-under-eyes', title: 'PRF Under-Eye', slug: 'prf-under-eyes', kind: 'treatment', public: true, order: 131, collectionSlug: 'injectables-bio-fillers', parentSlug: 'prf', providerId: 'provider-diana', providerScope: PRF_RN_SCOPE, duration: '1 hour 15 minutes', bookingMode: 'consultation', bookingUrl: 'https://houseofrose.glossgenius.com/book?service_token=1000f-ad1f8f2c-7475-4776-b6d9-c8d5e9bff604', bookingVerifiedAt: '2026-09-02', concernSlugs: ['dark-circles', 'volume-loss'], relatedSlugs: ['prf-injections'], _updatedAt: '2026-08-27T00:00:00Z',
  },
  {
