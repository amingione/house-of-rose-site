...
const SERVICE_RECORDS: readonly ServiceRecord[] = [
  ...
  {
    _id: 'f5308b9c-73df-4812-8c0d-afcf4ee5839a', title: 'Microneedling', slug: 'microneedling', kind: 'hub', public: true, order: 110, collectionSlug: 'facials', providerId: 'provider-amber', providerScope: ESTHETICS_MEDICAL_SCOPE, bookingMode: 'consultation', bookingUrl: 'https://houseofrose.glossgenius.com/book?service_token=1000f-5b4391bb-3d43-40f3-910d-144cf0e46192', bookingVerifiedAt: '2026-08-04', concernSlugs: ['aging', 'acne-scarring', 'fine-lines-laxity', 'sun-damage', 'texture', 'stretch-marks', 'hyperpigmentation'], relatedSlugs: ['biorepeel', 'glo2facial', 'dermaplaning'], _updatedAt: '2026-08-27T00:00:00Z',
  },
  {
  ...
  {
    _id: 'service-prf-under-eyes', title: 'PRF Under-Eye', slug: 'prf-under-eyes', kind: 'treatment', public: true, order: 131, collectionSlug: 'injectables-bio-fillers', parentSlug: 'prf', providerId: 'provider-diana', providerScope: PRF_RN_SCOPE, duration: '1 hour 15 minutes', bookingMode: 'consultation', bookingUrl: 'https://houseofrose.glossgenius.com/book?service_token=1000f-7a950500-c694-4a9c-9a25-f98fd4e72e6c', bookingVerifiedAt: '2026-08-13', concernSlugs: ['dark-circles', 'volume-loss'], relatedSlugs: ['prf-injections'], _updatedAt: '2026-08-27T00:00:00Z',
  },
  {
