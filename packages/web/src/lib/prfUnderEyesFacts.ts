...
export const PRF_UNDER_EYES_FAQS = [
  ...
  },
  {
    ...
    answer:
      'No. Injectable PRF is performed by Diana Morrison, RN. During eligible microneedling with Amber Mingione, Licensed Esthetician, topical PRF is applied to the skin surface.',
  },
  {
...
export const PRF_UNDER_EYES_EVIDENCE = [
  {
    title: 'Autologous platelet concentrates for facial rejuvenation',
    publication: 'Journal of Applied Oral Science, 2022',
    url: 'https://pubmed.ncbi.nlm.nih.gov/36074433/',
  },
  {
    title: 'Infraorbital dark circles: definition, causes, and treatment options',
    publication: 'Dermatologic Surgery, 2009',
    url: 'https://pubmed.ncbi.nlm.nih.gov/19469797/',
  },
] as const;
