...
Use these exact values when setting up the GBP. Copy-paste — do not retype.
...
## Services to Add in GBP (Products/Services section)
...
- [ ] Online appointments available (link to Gloss Genius)
- [ ] Wheelchair accessible entrance
- [ ] Wheelchair accessible restroom (if true)
- [ ] Private parking available (confirm)
- [ ] Credit cards accepted
- [ ] LGBTQ+ friendly (optional)

---

## Photos to Upload at Launch
...
## Q&A — Pre-Load These 5 Questions

Go to the Q&A section and post these yourself (as the owner) so they appear proactively:

**Q: Do you offer consultations before treatment?**  
A: Yes — every service at House of Rose begins with a private consultation to assess your needs and design a personalized protocol. Call (844) 941-7673 or book online to schedule yours.
...
## First Google Post (Welcome Post)
...
4. **Review response template (positive)**:
   ```
   Thank you so much, [Name] — it was a pleasure having you at House of Rose. 
   We look forward to seeing you again. — The House of Rose Team
   ```
