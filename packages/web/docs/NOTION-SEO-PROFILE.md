# House of Rose — Notion SEO Profile
**Created**: 2026-04-28  
**Use**: Copy this structure into Notion. Each `##` section = one Notion page or database.
...
| Engagement start | 2026-04-28 |
| Stack | Astro v5 (static), Tailwind CSS, TypeScript |
...
**Audience:** Women 35–65 in SW Florida. Health-conscious, discerning, done with generic experiences.
...
**Voice DO:** "Every treatment begins with a private consultation."
**Voice DON'T:** "We're so excited to pamper you!"
...
| OG + Twitter Card | ✅ | BaseLayout |
| LCP preload hint | ✅ | Hero images |
| WebP images | ✅ | All 20 public images |
...
| Facebook Business | P1 | ⚠️ Pending |
| Healthgrades | P1 | ⚠️ Pending |
| Vagaro | P1 | ⚠️ Pending |
| BBB | P2 | ⚠️ Pending |
| StyleSeat | P2 | ⚠️ Pending |
| RealSelf | P2 | ⚠️ Pending |
| Foursquare | P2 | ⚠️ Pending |
| Nextdoor | P2 | ⚠️ Pending |
...
| September 2026 | GLP-1 Plateaus: Why They Happen and What to Do | GLP-1 Weight Loss | GLP-1 weight loss plateau |
| October 2026 | Treating Sun Damage in Florida Skin | Skin Rejuvenation | sun damage treatment Florida |
| October 2026 | What Is Tirzepatide? | GLP-1 Weight Loss | tirzepatide weight loss |

---

## 60-Day KPI Tracker

*Create this as a Notion database with these properties:*

**Properties:**
- Date (date)
- Organic Sessions (number)
- Contact Submits (number)
- Book Now Clicks (number)
- Phone Clicks (number)
- Top Keyword Position (text)
- GBP Views (number)
- Notes (text)

**Populate on**: 1st and 15th of each month.
...
| Gloss Genius | houseofrose.glossgenius.com | ✅ Live |

---

## Deliverables Index

All deliverable documents live in `packages/web/docs/`:

| File | Contents |
|------|----------|
| `BRAND_VOICE.md` | Brand voice guide, tone, messaging rules |
| `KEYWORD-MAP.md` | 70+ keywords, intent classification, page mapping |
| `TOPICAL-CLUSTERS.md` | Hub-and-spoke architecture, 25 planned blog posts |
| `COMPETITOR-GAP-ANALYSIS.md` | 3 competitors profiled, gap matrix |
| `CONTENT-CALENDAR-6MO.md` | 12 posts May–Oct 2026 with full specs |
| `NAP-CANONICAL.md` | Canonical NAP, citation directory tracker |
| `BUSINESS-PROFILE-GBP.md` | Pre-filled GBP setup, Q&As, welcome post |
| `ANALYTICS-SETUP.md` | GA4 property setup + event tracking guide |
| `GSC-SUBMISSION.md` | GSC verification + Bing submission guide |
| `MONITORING-BASELINE.md` | 60-day monitoring tracker + alert thresholds |
| `GROWTH-SYSTEM-REPORT.md` | Full engagement summary, all 14 phases |
