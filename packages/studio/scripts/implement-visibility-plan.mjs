...
const servicePatches = [
  ...
  },
  {
    ...
    set: {
      title: 'Topical PRF with Microchanneling or Microneedling',
      ...
      description: 'Topical PRF is prepared from a small sample of your blood and applied to the skin surface during an appropriate microchanneling or microneedling protocol. It is not injected and is not described as being delivered into the skin. Amber confirms candidacy, selects the needling approach, and provides written aftercare. The currently verified PRF Skin Renewal appointment is $450.',
      whoItsFor: 'Clients already suited to microchanneling or microneedling who want to discuss a topical, client-derived adjunct. Amber confirms whether the treatment area, health history, and selected protocol make topical PRF appropriate.',
      process: [
        'Complete a skin consultation and candidacy review.',
        'Confirm whether microchanneling or microneedling fits the visible concern.',
      ...
      faqs: [
        faq('what-is-prf-needling', 'What is PRF microneedling?', 'At House of Rose, this means a provider-selected microchanneling or microneedling protocol with PRF applied topically to the skin surface. Amber’s PRF role is topical only; injectable PRF is Diana, RN’s separate lane.'),
      ...
      seo: {
        ...
        metaDescription: 'Learn how topical PRF is used with microchanneling or microneedling, who may be a candidate, and the verified $450 appointment.',
      },
    },
  },
  {
...
const supportingDocuments = [
  {
    ...
    costFactors: [
      { _key: 'protocol', factor: 'Selected needling protocol', effect: 'Amber determines whether microchanneling or microneedling fits the visible concern and candidacy.' },
...
transaction = transaction
  ...
  .patch('383712f3-f854-491c-954c-7b6fa6420827', {
    set: {
      title: 'Microchanneling vs. Microneedling: Which Fits Your Goals?',
      slug: slug('microchanneling-vs-microneedling'),
      seo: {
        _type: 'seo',
        metaTitle: 'Microchanneling vs Microneedling in Punta Gorda',
        metaDescription: 'Compare microchanneling and microneedling by protocol, concern, treatment area, and recovery planning at House of Rose in Punta Gorda.',
      },
    },
  })
