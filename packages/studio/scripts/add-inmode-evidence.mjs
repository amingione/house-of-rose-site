...
const services = [
  {
    ...
    evidenceMedia: [
      ...
      media({
        key: 'morpheus8-abdomen-example',
        kind: 'before-after',
        filename: 'NB_M8B_BeforeAfter_24Weeks_Abd_Zoomed-TM.jpg',
        alt: 'Manufacturer-provided abdominal Morpheus8 before and after example',
        title: 'Selected Body-Area Example',
        caption:
          'A manufacturer-provided example illustrating visible abdominal skin-quality change following a Morpheus8 body protocol. This is not a House of Rose client.',
        sourceCredit: 'Manufacturer-provided treatment example; attribution embedded in image',
      }),
      media({
        key: 'morpheus8-buttocks-example',
        kind: 'before-after',
        filename: 'Morpheus8-Burst-Deep-Before-and-After-Buttocks.png',
        alt: 'Manufacturer-provided Morpheus8 before and after example for the buttocks',
        title: 'Body Texture Example',
        caption:
          'A manufacturer-provided example illustrating visible texture change on a clinician-selected body area. This is not a House of Rose client.',
        sourceCredit: 'Manufacturer-provided treatment example; attribution embedded in image',
      }),
    ],
    researchReferences: [],
