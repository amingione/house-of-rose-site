...
const textReplacements = [
  ...
  [/complimentary AI-assisted skin analysis/gi, 'AI-assisted skin analysis'],
  [/complimentary AI skin analysis/gi, 'AI skin analysis'],
  [/complimentary skin analysis/gi, 'skin analysis'],
  ...
  [/a private, appointment-only/gi, 'an advanced'],
  [/appointment-only/gi, 'appointment-friendly'],
