 ...
 *
 * Every price here is mirrored from `docs/internal_only/services/ALL-SERVICES-PRICING.MD`
...
export const TREATMENT_CONTENT = [
  ...
  {
    slug: 'botox-daxxify',
    // Live doc is titled "Neurotoxin Injections", slugged `injectables` — verified
    // 2026-08-06. No separate Botox-only or Daxxify-only page exists; both products
    // are sold from this one page at the same $14/unit, matching the content below.
    aliases: ['injectables', 'botox', 'daxxify', 'neurotoxin', 'tox'],
  ...
  {
    slug: 'iv-hydration',
    // Live doc is actually slugged `iv-hydration-therapy` — verified 2026-08-06 via
    // Sanity query, added as an alias rather than renamed so the content-file slug
    // stays the semantic id used elsewhere in this file (e.g. BLOCKED_TREATMENTS refs).
    aliases: ['iv-hydration-therapy', 'iv-therapy', 'hydration-iv', 'iv'],
  ...
  {
    slug: 'acne-program',
    aliases: ['acne-bootcamp', 'face-reality', 'acne', 'face-reality-acne-program', 'face-reality-acne-treatment'],
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    // Live doc is actually slugged `glp-1-weight-management` — verified 2026-08-06.
    aliases: ['glp-1-weight-management', 'glp-1', 'semaglutide', 'tirzepatide', 'medical-weight-loss'],
